...
<style lang="scss">
@import "../scss/variables/theme-light";
$handle-bg: $primary;
$handle-width: 30px;
$handle-height: 30px;
$handle-chevron-size: 20px;
$handle-line-bg: $primary;
...
.handle-line {
  ...
  position: absolute;
  top: 0;
  width: $handle-line-width;
  height: 100%;
  background: $primary;
  z-index: $z-index-handle-line;
  pointer-events: none;
  user-select: none;
}
